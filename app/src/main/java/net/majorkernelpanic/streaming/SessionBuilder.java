...
public class SessionBuilder {
	...
	/**
	 * Creates a new {@link net.majorkernelpanic.streaming.Session}.
	...
	/** Returns the context set with {@link #setContext(android.content.Context)}*/
	...
	/** Returns the SurfaceView set with {@link #setSurfaceView(net.majorkernelpanic.streaming.gl.SurfaceView)}. */
